...
class SchemaGenerator {
    static async generateFromMetadata(options) {
        ...
        if (!options.skipCheck) {
            const { errors } = await (0, graphql_1.graphql)({ schema, source: (0, graphql_1.getIntrospectionQuery)() });
            if (errors) {
    ...
    static generateFromMetadataSync(options) {
        ...
        const orphanedTypes = (_a = options.orphanedTypes) !== null && _a !== void 0 ? _a : [];
    ...
    static getResolveTypeFunction(resolveType, possibleObjectTypesInfo) {
        return async (...args) => {
            ...
            if (!resolvedType || typeof resolvedType === "string") {
                return resolvedType !== null && resolvedType !== void 0 ? resolvedType : undefined;
            }
